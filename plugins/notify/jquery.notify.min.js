			...
			s = {
				...
				_setContent: function () {
					...
					if (t.title && t.title != null) {
						r.find(t._classes.content).prepend("<span>" + t.title + "</span>")
					} else {
						r.addClass("notify-without-title")
					}
					if (t.message && t.message != null) {
						r.find(t._classes.content).append(t.message)
					}
					...
					if (t.icon && t.icon != null) {
						...
						r.prepend('<div class="comprou-left">' + t.icon + "</div>")
					} else {
					...
					if (t.closeBtn) {
						r.prepend('<a href="javascript:;" class="notify-close-btn"><span class="comprou-fechar">x</span></a>');
